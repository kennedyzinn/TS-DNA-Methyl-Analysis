...
chr <- factor(sample_sheet$Karyotype, labels=c("45X","46XX"))
...
capture.output(compact(hyper.gene.list), file = "interaction_hypermethyl_genes.txt")
capture.output(compact(hypo.gene.list), file = "interaction_hypomethyl_genes.txt")
```
