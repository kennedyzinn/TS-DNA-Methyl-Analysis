...
```
```{r}
# difference in methylation changes from ipsc OR NCC to EC in aneuploid compared to euploid
...
x_gsa <- goregion(x.ranges, all.cpg = rownames(top), collection = "KEGG", array.type="EPIC", anno=anno, sig.genes=T)
