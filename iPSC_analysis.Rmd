...
gene_plot <- ggplot(res, aes(x = MethylationStatus, y = Gene)) +
  ...
  labs(x = "Average Difference (Beta-value)", 
       y = "Gene",
       title = glue("Differentially Methylated Genes of iPSCs")) +
  geom_vline(xintercept = 0, linetype = "dashed", alpha = 0.5)
ggsave(glue("gene_plot_iPSC_{descriptor}.pdf"), gene_plot, width = 8, height = 8)
}
...
write.csv(top.kegg, "IPSC_kegg_region.csv")
write.csv(top.go, "IPSC_go_region.csv")

# create csv of gene list
write.csv(results, "IPSC_genes.csv")
```
